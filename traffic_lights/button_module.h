 ...
 *   - The static library "libece4220lab3.a" (C programs) or "libece4220lab3_cpp.a" (C++ programs).
 *
 * For convenience, copy the files to your lab 3 project directory (or wherever you prefer).
 *
 * To be able to use the check_button and clear_button functions in your programs, you 
